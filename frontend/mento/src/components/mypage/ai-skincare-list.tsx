...
export function AiSkincareList({
  diagnoses,
  onViewDetail,
}: AiSkincareListProps) {
    ...
    <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-border">
        {diagnoses.map((diagnosis, index) => (
          ...
          >
            {/* Index */}
            <div className="col-span-2 flex items-center text-sm text-foreground justify-center">
              {index + 1}
            </div>

            {/* Diagnosis Date */}
            <div className="col-span-4 flex items-center text-sm text-foreground justify-center">
