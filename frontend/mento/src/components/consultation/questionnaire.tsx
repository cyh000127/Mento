...
const questionsByCategory: Record<NonNullable<ConsultationCategory>, string[]> = {
  skincare: [
    "현재 피부 고민이나 관심사가 무엇인가요?",
    "현재 사용 중인 스킨케어 제품이 있다면 알려주세요.",
    "피부 관련 알레르기나 민감한 성분이 있나요?",
  ],
  beauty: [
    "평소 메이크업 스타일이나 선호하는 룩이 있나요?",
    "퍼스널 컬러 진단을 받아보신 적이 있나요?",
    "메이크업 관련해서 가장 어려운 점이 무엇인가요?",
  ],
  hair: [
    "현재 헤어 스타일에서 불만족스러운 점이 있나요?",
    "선호하는 헤어 스타일이나 참고 이미지가 있나요?",
    "두피나 모발 관련 고민이 있다면 알려주세요.",
  ],
}
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mt-8 rounded-2xl border border-border bg-card p-8 shadow-sm">
        ...
        {/* Question Text */}
        <h2 className="mb-8 text-center text-xl font-medium text-text-primary">
