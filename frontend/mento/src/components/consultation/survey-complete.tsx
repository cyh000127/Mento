...
export function SurveyComplete({ onGoToPayment }: SurveyCompleteProps) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center">
      ...
      {/* Message */}
      <h1 className="mt-10 text-center text-2xl font-bold text-text-primary">설문이 완료되었습니다</h1>
      <p className="mt-3 text-center text-lg text-text-secondary">결제를 완료해 주세요</p>
      ...
      <div className="mt-8 max-w-md rounded-xl border border-border bg-muted/50 p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-relaxed text-text-secondary">결제 완료 후 상담 예약이 확정되며, 예약 내역은 마이페이지에서 확인하실 수 있습니다.</p>
          </div>
        </div>
      </div>
