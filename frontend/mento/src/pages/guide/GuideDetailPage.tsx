      ...
      <section className="bg-gradient-to-br from-pastel-blue-100/50 via-background to-primary-100/30 py-8 md:py-12">
        <div className="mx-auto max-w-[1400px] px-6">
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">{productType} 사용 가이드</h1>
            ...
            {contentTypes.map((type) => (
              <button
                ...
                className={`
                  ...
                  ${selectedContent === type.id ? "bg-primary-500 text-white shadow-md" : "bg-muted text-text-secondary hover:bg-muted/80"}
                `}
              >
                {type.label}
              </button>
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-12">
        <div className="rounded-2xl p-6 md:p-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              <FaceCameraSection selectedArea={selectedArea} onAreaSelect={setSelectedArea} />
            </div>
