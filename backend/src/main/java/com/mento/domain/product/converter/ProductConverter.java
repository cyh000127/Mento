...
public class ProductConverter {
	...
	public ProductResDto toProductResDto(final Product entity) {
		return ProductResDto.builder()
			...
			.skinTypes(JsonStringConverter.toJsonString(entity.getSkinTypes()))
			.relatedConditions(JsonStringConverter.toJsonString(entity.getRelatedConditions()))
			.benefits(JsonStringConverter.toJsonString(entity.getBenefits()))
